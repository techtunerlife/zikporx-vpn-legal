...
- The server address and ports you enter.
- A device name or label.
- Cryptographic enrollment material and VPN configuration data.
- Connection status and technical information needed to operate the tunnel.
...
VPN traffic travels between your device and the server you select. TechTunerLife does not receive, inspect, or store the contents of that traffic. Your server, hosting provider, internet provider, network equipment, or other services you use may process information under their own policies and configurations.

Your self-hosted server may create system or application logs. You control that server and are responsible for its configuration, access, security, and retention settings.
...
We do not sell personal information. We may disclose information you voluntarily provide when reasonably necessary to:

- Provide support you request.
- Comply with applicable law or a valid legal process.
- Protect the rights, safety, and security of users, TechTunerLife, or others.
- Complete a corporate transaction, subject to appropriate protections.

Apple and the App Store may process information independently under their own policies.
...
For privacy questions, support, or licensing inquiries, contact:
